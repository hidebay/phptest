[{capture append="oxidBlock_content"}]
    ...
    [{block name="checkout_thankyou_main"}]
        ...
        <div id="thankyouPage">
          <div class="lineBox option">
            <h3>[{ oxmultilang ident="TRO_FINISHED" }]</h3>
            <p>[{ oxmultilang ident="TRO_FINISHED_TEXT" }]</p>
          </div>
            ...
            [{block name="checkout_thankyou_proceed"}]
                [{ oxmultilang ident="TRO_PAGE_CHECKOUT_THANKYOU_YOUCANGO" }]
                <a id="backToShop" rel="nofollow" href="[{ oxgetseourl ident=$oViewConf->getHomeLink() }]" class="link">[{ $oxcmp_shop->oxshops__oxname->value }]</a>
