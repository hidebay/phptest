[{oxifcontent ident="trokontakt" object="oContent"}]
...
<div class="checkoutCollumns">
  <h3>[{ oxmultilang ident="FORM_CONTACT_EMAIL2" }]</h3>
  <form class="js-oxValidate" action="[{ $oViewConf->getSslSelfLink() }]" method="post">
      ...
      <ul class="form clear">
          ...
          <li>
              <button class="sendmessage" type="submit">[{ oxmultilang ident="FORM_CONTACT_SEND" }]</button>
          </li>
      </ul>
  </form>
</div>
