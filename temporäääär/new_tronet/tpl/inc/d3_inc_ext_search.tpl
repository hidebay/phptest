...
[{if $oView->getSearchViewListType() == 'linklist'}]
            ...
            <div class="list">
               [{if $sSelectedCatId}]
                  <div class="buttonframe">
                      <a class="button" onclick="d3_extsearch_popup.popup.load();" href="[{$oViewConf->getSelfLink()}][{$additionalparams|replace:$sSelectedCatId:''}]">
               ...
               [{elseif $oView->d3GetCategoryList()}]
                    ...
                    [{foreach from=$oView->d3GetCategoryList() name=search item=category}]
                        <div class="item">
                            <a href="[{ oxgetseourl ident=$oViewConf->getSelfLink()}][{$additionalparams}]&searchcnid=[{$category->oxcategories__oxid->value}]&isextsearch=true" [{if $oView->noIndex() }] rel="nofollow"[{/if}] onclick="d3_extsearch_popup.popup.load();">[{$category->oxcategories__oxtitle->value}][{if $category->oxcategories__counter->value}] ([{$category->oxcategories__counter->value}])[{/if}]</a>
                        </div>
                    [{/foreach}]

                    [{if $limitedCatSearch}]
                        <div class="clearitem"></div>
                        <div class="buttonframe"><a class="button" href="[{$oViewConf->getSelfLink()}][{$additionalparams}]&showall_categories=1" onclick="d3_extsearch_popup.popup.load();">[{oxmultilang ident="D3_EXTSEARCH_EXT_SHOWALL"}]</a></div>
                    [{elseif $limitedCatButton}]
                        <div class="clearitem"></div>
                        <div class="buttonframe"><a class="button" href="[{$oViewConf->getSelfLink()}][{$additionalparams}]&showall_categories=0" onclick="d3_extsearch_popup.popup.load();">[{oxmultilang ident="D3_EXTSEARCH_EXT_SHOWLESS"}]</a></div>
                    [{/if}]
        ...
        <div class="d3_extsearch_navigation baseframe">
            ...
            <div class="list">
               [{if $sSelectedVendorId}]
                  <div class="buttonframe">
                      <a class="button" onclick="d3_extsearch_popup.popup.load();" href="[{$oViewConf->getSelfLink()}][{$additionalparams|replace:$sSelectedVendorId:''}]">
               ...
               [{elseif $oView->d3GetVendorList()}]
                    ...
                    [{foreach from=$oView->d3GetVendorList() name=search item=vendor}]
                        <div class="item">
                            <a href="[{ oxgetseourl ident=$oViewConf->getSelfLink()}][{$additionalparams}]&searchvendor=[{$vendor->oxvendor__oxid->value}]&isextsearch=true" " [{if $oView->noIndex() }] rel="nofollow"[{/if}] onclick="d3_extsearch_popup.popup.load();">[{$vendor->oxvendor__oxtitle->value}] ([{$vendor->oxvendor__counter->value}])</a>
                        </div>
                    [{/foreach}]

                    [{if $limitedVendorSearch}]
                        <div class="clearitem"></div>
                        <div class="buttonframe"><a class="button" href="[{$oViewConf->getSelfLink()}][{$additionalparams}]&showall_vendors=1" onclick="d3_extsearch_popup.popup.load();">[{oxmultilang ident="D3_EXTSEARCH_EXT_SHOWALL"}]</a></div>
                    [{elseif $limitedVendorButton}]
                        <div class="clearitem"></div>
                        <div class="buttonframe"><a class="button" href="[{$oViewConf->getSelfLink()}][{$additionalparams}]&showall_vendors=0" onclick="d3_extsearch_popup.popup.load();">[{oxmultilang ident="D3_EXTSEARCH_EXT_SHOWLESS"}]</a></div>
                    [{/if}]
        ...
        <div class="d3_extsearch_navigation baseframe">
            ...
            <div class="list">
               [{if $sSelectedManufacturerId}]
                  <div class="buttonframe">
                      <a class="button" onclick="d3_extsearch_popup.popup.load();" href="[{$oViewConf->getSelfLink()}][{$additionalparams|replace:$sSelectedManufacturerId:''}]">
               ...
               [{elseif $oView->d3GetManufacturerList()}]
                    ...
                    [{foreach from=$oView->d3GetManufacturerList() name=search item=manufacturer}]
                        <div class="item">
                            <a href="[{ oxgetseourl ident=$oViewConf->getSelfLink()}][{$additionalparams}]&searchmanufacturer=[{$manufacturer->oxmanufacturers__oxid->value}]&isextsearch=true" " [{if $oView->noIndex() }] rel="nofollow"[{/if}] onclick="d3_extsearch_popup.popup.load();">[{$manufacturer->oxmanufacturers__oxtitle->value}] ([{$manufacturer->oxmanufacturers__counter->value}])</a>
                        </div>
                    [{/foreach}]

                    [{if $limitedManufacturerSearch}]
                        <div class="clearitem"></div>
                        <div class="buttonframe"><a class="button" href="[{$oViewConf->getSelfLink()}][{$additionalparams}]&showall_manufacturers=1" onclick="d3_extsearch_popup.popup.load();">[{oxmultilang ident="D3_EXTSEARCH_EXT_SHOWALL"}]</a></div>
                    [{elseif $limitedManufacturerButton}]
                        <div class="clearitem"></div>
                        <div class="buttonframe"><a class="button" href="[{$oViewConf->getSelfLink()}][{$additionalparams}]&showall_manufacturers=0" onclick="d3_extsearch_popup.popup.load();">[{oxmultilang ident="D3_EXTSEARCH_EXT_SHOWLESS"}]</a></div>
                    [{/if}]
    ...
    [{if $oView->d3GetAttributeList()}]
        <form action="[{ $oViewConf->getSelfActionLink() }]" method="post" id="d3searchfilterform">
            ...
            <input type="hidden" name="searchparam" value="[{$searchparamforhtml}]">
            ...
            <div class="d3_extsearch_navigation baseframe">
                <h4 class="headline">
                    [{oxmultilang ident="D3_EXTSEARCH_EXT_HITSATTRIBS"}]
                </h4>
                <div class="list">
                        ...
                        <div class="item">
                            <select name="d3searchattrib[[{$key}]]" onchange="d3_extsearch_popup.popup.load(); document.getElementById('d3searchfilterform').submit();">
                                ...
                                [{foreach from=$oAttribute->_aList name=attrvalues key=valuekey item=oAttrValue}]
                                    <option value="[{$oAttrValue->rawvalue}]" [{if $oAttrValue->selected}] selected[{/if}]>[{$oAttrValue->value}] ([{$oAttrValue->count}])</option>
                                [{/foreach}]
                            </select>
                        </div>
                    [{/foreach}]
        ...
        <div class="d3_extsearch_navigation baseframe">
            ...
            <div class="list">
                [{if $sSelectedPriceStep}]
                    <div class="buttonframe">
                        <a class="button" onclick="d3_extsearch_popup.popup.load();" href="[{$oViewConf->getSelfLink()}][{$additionalparams|replace:$sSelectedPriceStep:''}]">
                ...
                [{elseif $oView->d3getPriceSteps()}]
                    [{foreach from=$oView->d3getPriceSteps() name=search item=price}]
                        <div class="item">
                            <a href="[{ oxgetseourl ident=$oViewConf->getSelfLink()}][{$additionalparams}]&priceselector=[{$price->addParam}]&isextsearch=true" " [{if $oView->noIndex() }] rel="nofollow"[{/if}] onclick="d3_extsearch_popup.popup.load();">[{oxmultilang ident="D3_EXTSEARCH_EXT_PRICEFROM"}] <b>[{$price->iFMin}] [{ $currency->sign}]</b> [{oxmultilang ident="D3_EXTSEARCH_EXT_PRICETO"}] <b>[{$price->iFMax}] [{ $currency->sign}]</b> ([{$price->iCount}])</a>
                        </div>
                    [{/foreach}]
...
[{else}]
    ...
    [{if $oView->d3HasjQuerySlider()}]
        [{include file="inc/d3_ext_search_slider.tpl"}]
    [{/if}]
...
[{*** put it in php !!! ***}]
                            ...
                            [{else}]
                                ...
                                [{foreach from=$oView->d3getPriceSteps() item="price"}]
                                    <OPTION value="[{$price->addParam}]">[{oxmultilang ident="D3_EXTSEARCH_EXT_PRICEFROM"}] [{$price->iFMin}] [{ $currency->sign}] [{oxmultilang ident="D3_EXTSEARCH_EXT_PRICETO"}] [{$price->iFMax}] [{ $currency->sign}] ([{$price->iCount}])</OPTION>
                                [{/foreach}]
                                [{if $sSelectedPriceStep}]
...
[{if $oView->hasFilterParams()}]
    <div class="d3_extsearch_navigation baseframe fit">
        [{include file="inc/d3_ext_search_filter.tpl" d3fdesc="D3_EXTSEARCH_EXT_ALL"|oxmultilangassign d3fparam="all"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="A"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="B"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="C"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="D"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="E"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="F"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="G"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="H"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="I"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="J"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="K"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="L"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="M"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="N"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="O"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="P"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="Q"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="R"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="S"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="T"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="U"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="V"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="W"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="X"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="Y"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="Z"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="1"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="2"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="3"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="4"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="5"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="6"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="7"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="8"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="9"}]
        [{include file="inc/d3_ext_search_filter.tpl" d3fparam="0"}]
    </div>
[{/if}]