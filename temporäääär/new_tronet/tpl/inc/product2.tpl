   ...
   [{/if}]
        ...
        [{oxhasrights ident="SHOWARTICLEPRICE"}]
            <div class="preis" style="right:7px;">
                <div class="artnum" style="font-size: 15px">[{ oxmultilang ident="INC_PRODUCTITEM_ARTNOMBER2" }] [{ $product->oxarticles__oxartnum->value }]</div>
                [{if $product->getFTPrice() }]
                    <div class="price tprice" id="test_product_tprice" style="text-decoration:line-through;color:#000000;font-size:18px;">[{ $product->getFTPrice() }] [{ $currency->sign}]</div>
                [{/if}]
