...
[{capture append="oxidBlock_pageHead"}]
    ...
    [{block name="base_style"}]
        ...
        [{oxstyle include="css/content.css"}]
...
[{* D3 Modul "extSearch" START}]
    [{d3modcfgcheck modid="d3_extsearch"}]
        [{oxstyle include="css/d3_ext_search.css"}]
...
[{* D3 Module "extSearch" START}]
    [{d3modcfgcheck modid="d3_extsearch"}]
        [{include file="widget/d3extsearch/d3_extsearch_ajax.tpl"}]
    [{/d3modcfgcheck}]
[{ D3 Module "extSearch" END *}]
