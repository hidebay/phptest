<form action="[{ $oViewConf->getSelfActionLink() }]" name="newsletter" method="post">
    <ul class="form inlineForm clear">
        <li>
            ...
            <button id="newsletterSettingsSave" type="submit" title="[{ oxmultilang ident="FORM_USER_NEWSLETTER_SAVE" }]" class="submitButton button">[{ oxmultilang ident="FORM_USER_NEWSLETTER_SAVE" }]</button>
