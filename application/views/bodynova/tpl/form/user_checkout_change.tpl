...
[{*** D3 MOD NEXT_LINE  * GoogleAnalytics ***}]
    ...
    [{block name="user_checkout_change_form"}]
        ...
        <div class="checkoutCollumns clear">
            <h3>[{ oxmultilang ident="TRO_CHECKOUT_INFO" }]</h3>
            <div class="collumn">
                ...
                <ul class="form" id="addressText">
                    ...
                    <li><button id="userChangeAddress" class="submitButton button" name="changeBillAddress" type="submit">[{ oxmultilang ident="PAGE_CHECKOUT_BASKET_CHANGE" }]</button></li>
                    <li>
        ...
        <div class="lineBox clear">
            <a href="[{ oxgetseourl ident=$oViewConf->getBasketLink() }]" class="prevStep submitButton" id="userBackStepBottom">[{ oxmultilang ident="TRO_FORM_USER_CHECKOUT_REGISTRATION_BACKSTEP" }]</a>
