            ...
            [{if $aVariantSelections && $aVariantSelections.selections }]
                ...
                [{if $blHasActiveSelections}]
                    <div class="variantReset">
                        [{* Reset link *}]
                        <a class="reset">[{ oxmultilang ident="DETAILS_VARIANTS_RESETSELECTION" }]</a>
                    ...
                    [{oxhasrights ident="TOBASKET"}]
                        [{if !$oDetailsProduct->isNotBuyable()}]
                          [{if $blCanBuy}]
                            ...
                            <button id="toBasket" type="submit" [{if !$blCanBuy}]disabled="disabled"[{/if}] class="submitButton button[{if !$blCanBuy}] inactive[{/if}]" title="[{oxmultilang ident="DETAILS_ADDTOCART"}]">[{oxmultilang ident="DETAILS_ADDTOCART"}]</button>
                          [{/if}]
                        [{/if}]
                    [{/oxhasrights}]
                [{/block}]
