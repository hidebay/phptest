[{assign var="invadr" value=$oView->getInvoiceAddress()}]
    ...
    [{if !$noFormSubmit}]
    <li class="formSubmit">
        <button id="accUserSaveTop" type="submit" name="save" class="submitButton button" title="[{ oxmultilang ident="FORM_FIELDSET_USER_BILLING_SAVE" }]">[{ oxmultilang ident="FORM_FIELDSET_USER_BILLING_SAVE" }]</button>
    </li>
    [{/if}]