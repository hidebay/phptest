...
<div class="addressCollumns clear">
    <div class="collumn">
        ...
        <ul class="form" id="addressText">
            ...
            <li>
                <button id="userChangeAddress" class="submitButton button" name="changeBillAddress" type="submit">[{ oxmultilang ident="PAGE_CHECKOUT_BASKET_CHANGE" }]</button>
            </li>
        </ul>
...
<div class="lineBox form clear">      
    <button id="accUserSaveTop" class="submitButton button" name="userform" type="submit">[{ oxmultilang ident="FORM_FIELDSET_USER_BILLING_SAVE" }]</button>
</div> 
</form>
