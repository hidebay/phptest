...
<form class="js-oxValidate" action="[{ $oViewConf->getSelfActionLink() }]" name="changepassword" method="post">
    ...
    <ul class="form clear">
        ...
        <li class="formSubmit">
            <button id="savePass" type="submit" title="[{ oxmultilang ident="FORM_USER_PASSWORD_SAVE" }]" class="submitButton button">[{ oxmultilang ident="FORM_USER_PASSWORD_SAVE" }]</button>
        </li>
    </ul>
</form>
