...
class dre_cleartmp_navigation extends dre_cleartmp_navigation_parent
{
    ...
    public function cleartmp()
    {
        ...
        $oConf->saveShopConfVar('bool', 'blDevMode', $blDevMode, $sShopId, 'module:dre_cleartmp');
    ...
    {
        return oxRegistry::getConfig()->getShopConfVar('blDevMode',null,'module:dre_cleartmp');
    }
