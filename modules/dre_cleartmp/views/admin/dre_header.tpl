...
<head>
    ...
    <link rel="stylesheet" href="[{$oViewConf->getModuleUrl('dre_cleartmp','out/admin/css/dre_cleartmp.css')}]">
    ...
    <ul>
      ...
      <li class="sep">
          <form method="post" action="[{$oViewConf->getSelfLink()}]" id="cleartmp">
              ...
              <span class="rc">[{ oxmultilang ident="DRE_CLEARTMP_LABEL" }]</span>
              <select name="clearoption">
                  <option value="none">[{ oxmultilang ident="DRE_CLEARTMP_PLEASECHOOSE" }]</option>
                  <option value="smarty">[{ oxmultilang ident="DRE_CLEARTMP_SMARTY" }]</option>
                  <option value="language">[{ oxmultilang ident="DRE_CLEARTMP_LANGUAGE" }]</option>
                  <option value="database">[{ oxmultilang ident="DRE_CLEARTMP_DATABASE" }]</option>
                  <option value="seo">[{ oxmultilang ident="DRE_CLEARTMP_SEO" }]</option>
                  <option value="complete">[{ oxmultilang ident="DRE_CLEARTMP_COMPLETE" }]</option>
              </select>
              ...
              <label for="devmode" class="rc[{if $prodmode}] disabled[{/if}]">[{ oxmultilang ident="DRE_CLEARTMP_DEVMODE" }]</label>
          </form>
      </li>
    </ul>
