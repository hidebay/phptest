...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
    ...
    <tr class="listitem">
        [{block name="admin_article_list_filter"}]
            ...
            <td valign="top" class="listfilter" colspan="3" nowrap>
                <div class="r1"><div class="b1">
                <div class="find">
    ...
    <tr class="listitem">
        [{block name="admin_article_list_sorting"}]
            ...
            <td class="listheader" colspan="2"><a href="Javascript:top.oxid.admin.setSorting( document.search, 'oxarticles', 'wnuserid', 'asc');document.search.submit();" class="listheader">[{ oxmultilang ident="USER_RIGHTS_ARTICLE_OWNER" }]</a></td>
        [{/block}]
    </tr>
...
[{foreach from=$mylist item=listitem}]
    ...
    [{block name="admin_article_list_item"}]
        ...
        <td valign="top" class="[{ $listclass}]"><div class="listitemfloating"><a href="Javascript:top.oxid.admin.editThis('[{ $listitem->oxarticles__oxid->value }]');" class="[{ $listclass}]">[{ $listitem->getArtOwner('oxusername')|oxtruncate:45:"..":true }]</a></div></td>
        <td class="[{ $listclass}]">
          [{if !$readonly}]
