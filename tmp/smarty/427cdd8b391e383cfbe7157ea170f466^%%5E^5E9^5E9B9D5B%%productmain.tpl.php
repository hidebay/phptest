...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'page/details/inc/productmain.tpl', 9, false),array('modifier', 'strip_tags', 'page/details/inc/productmain.tpl', 47, false),array('function', 'oxscript', 'page/details/inc/productmain.tpl', 16, false),array('function', 'oxmultilang', 'page/details/inc/productmain.tpl', 46, false),array('function', 'oxgetseourl', 'page/details/inc/productmain.tpl', 281, false),array('block', 'oxhasrights', 'page/details/inc/productmain.tpl', 19, false),)), $this); ?>
...
<div class="detailsInfo clear">
    <meta itemprop='productID' content='sku:<?php echo $this->_tpl_vars['oDetailsProduct']->oxarticles__oxartnum->value; ?>
'>
    <meta itemprop="url"  content="<?php echo $this->_tpl_vars['oDetailsProduct']->getMainLink(); ?>
">
...
" class="cloud-zoom" id="zoom1" rel="adjustY:-2, zoomWidth:'354', fixZoomWindow:'350', trImg:'<?php echo $this->_tpl_vars['oViewConf']->getImageUrl('dot.png'); ?>
', loadingText:'<?php echo smarty_function_oxmultilang(array('ident' => 'PAGE_DETAILS_ZOOM_LOADING'), $this);?>
'">
                    <img itemprop="image" src="<?php echo $this->_tpl_vars['oView']->getActPicture(); ?>
...
">
        ...
        <div class="information">
            ...
            <?php echo smarty_function_oxscript(array('add' => "$( '#productTitle' ).oxArticleActionLinksSelect();"), $this);?>
                ...
                <h1 id="productTitle"><span itemprop="name"><?php echo $this->_tpl_vars['oDetailsProduct']->oxarticles__oxtitle->value; ?>
 </span></h1>
...
">
            ...
            <?php $this->_tag_stack[] = array('oxhasrights', array('ident' => 'SHOWSHORTDESCRIPTION')); $_block_repeat=true;smarty_block_oxhasrights($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
                <?php if ($this->_tpl_vars['oDetailsProduct']->oxarticles__oxshortdesc->value): ?>
                    <div class="shortDescription description" id="productShortdesc" itemprop="description"><?php echo $this->_tpl_vars['oDetailsProduct']->oxarticles__oxshortdesc->value; ?>
</div>
                <?php endif; ?>
            <?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_oxhasrights($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "widget/product/selectbox.tpl", 'smarty_include_vars' => array('oSelectionList' => $this->_tpl_vars['oList'],'iKey' => $this->_tpl_vars['iKey'])));
 ...
 ?>
                ...
                <?php if ($this->_tpl_vars['blHasActiveSelections']): ?>
                    <div class="variantReset">
                                                <a class="reset"><?php echo smarty_function_oxmultilang(array('ident' => 'DETAILS_VARIANTS_RESETSELECTION'), $this);?>
</a>
 ...
 ?>
        ...
        <div class="tobasket" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
            <?php if (! $this->_tpl_vars['blCanBuy']): ?>
                <p class="hint">
                  <?php echo smarty_function_oxmultilang(array('ident' => 'TRO_CHOOSE_ATRCILE'), $this);?>
...
strich.png">
                          <?php echo $this->_tpl_vars['oDetailsProduct']->getFTPrice(); ?>
                    ...
                    <?php $this->_tag_stack[] = array('oxhasrights', array('ident' => 'SHOWARTICLEPRICE')); $_block_repeat=true;smarty_block_oxhasrights($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
                        <?php if ($this->_tpl_vars['oDetailsProduct']->getFPrice()): ?>
                            <label id="productPrice" class="price">
                                ...
                                <?php if ($this->_tpl_vars['oDetailsProduct']->oxarticles__bodyshowprice == '1'): ?>
                                    <strong><span itemprop="price"><?php echo $this->_tpl_vars['fPrice']; ?>
                    ...
                    <?php $this->_tag_stack[] = array('oxhasrights', array('ident' => 'TOBASKET')); $_block_repeat=true;smarty_block_oxhasrights($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
                        <?php if (! $this->_tpl_vars['oDetailsProduct']->isNotBuyable()): ?>
                          <?php if ($this->_tpl_vars['blCanBuy']): ?>
                            ...
                            <button id="toBasket" type="submit" <?php if (! $this->_tpl_vars['blCanBuy']): ?>disabled="disabled"<?php endif; ?> class="submitButton button<?php if (! $this->_tpl_vars['blCanBuy']): ?> inactive<?php endif; ?>" title="<?php echo smarty_function_oxmultilang(array('ident' => 'DETAILS_ADDTOCART'), $this);?>
...
" rel="nofollow"><?php echo smarty_function_oxmultilang(array('ident' => 'PAGE_DETAILS_LOGGINTOACCESSNOTICELIST'), $this);?>
 ...
 <?php echo $this->_tpl_vars['currency']->sign; ?>
/<?php echo $this->_tpl_vars['oDetailsProduct']->oxarticles__oxunitname->value; ?>
</span>
                        <?php endif; ?>
 ...
 <?php echo $this->_tpl_vars['oDetailsProduct']->getDeliveryDate(); ?>
                        ...
                        <?php elseif ($this->_tpl_vars['oDetailsProduct']->getStockStatus() == 1): ?>
                            <span class="stockFlag lowStock" itemprop="availability" href="http://schema.org/InStock"><?php echo smarty_function_oxmultilang(array('ident' => 'DETAILS_LOWSTOCK'), $this);?>
</span>
