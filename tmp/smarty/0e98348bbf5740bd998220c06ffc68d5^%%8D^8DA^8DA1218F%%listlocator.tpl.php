...
<div style='position: absolute; z-index:9999;color:white;background: #789;
                 padding:0 15 0 15'>widget/locator/listlocator.tpl</div><!-- widget/locator/listlocator.tpl template start --><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<!-- widget/locator/listlocator.tpl template end -->