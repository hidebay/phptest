<?php /* Smarty version 2.6.26, created on 2014-04-10 13:36:09
         compiled from list_user.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'oxmultilangassign', 'list_user.tpl', 1, false),array('modifier', 'cat', 'list_user.tpl', 7, false),array('modifier', 'oxformdate', 'list_user.tpl', 105, false),array('modifier', 'oxaddslashes', 'list_user.tpl', 145, false),array('function', 'oxmultilang', 'list_user.tpl', 66, false),)), $this); ?>
...
?>
          <?php if ($this->_tpl_vars['menuitem']->nodeType == XML_ELEMENT_NODE && $this->_tpl_vars['menuitem']->childNodes->length): ?>
            <?php if ($this->_tpl_vars['menuitem']->getAttribute('id') == 'mxuadmin'): ?>
...
?>
                <?php if ($this->_tpl_vars['submenuitem']->nodeType == XML_ELEMENT_NODE && $this->_tpl_vars['submenuitem']->getAttribute('cl') == 'admin_user'): ?>
...
" method="post">
    ...
    <tr>
        ...
        <td class="listfilter first">
            ...
            <input class="listedit" type="text" size="15" maxlength="128" name="where[oxuser][oxfname]" value="<?php echo $this->_tpl_vars['where']['oxuser']['oxfname']; ?>
">
            </div></div>
        </td>
        <td class="listfilter">
            <div class="r1"><div class="b1">
            <input class="listedit" type="text" size="15" maxlength="128" name="where[oxuser][oxlname]" value="<?php echo $this->_tpl_vars['where']['oxuser']['oxlname']; ?>
">
            </div></div>
        </td>
        <td class="listfilter">
            <div class="r1"><div class="b1">
            <input class="listedit" type="text" size="15" maxlength="128" name="where[oxuser][oxusername]" value="<?php echo $this->_tpl_vars['where']['oxuser']['oxusername']; ?>
">
            </div></div>
        </td>
        <td class="listfilter">
...
">
                ...
                <input class="listedit" type="text" size="15" maxlength="128" name="where[oxuser][oxregister]" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['where']['oxuser']['oxregister'])) ? $this->_run_mod_handler('oxformdate', true, $_tmp) : smarty_modifier_oxformdate($_tmp)); ?>
">
              </div>
            </div>
        </td>
...
<tr>
        ...
        <td class="listheader first"><a href="javascript:top.oxid.admin.setSorting( document.forms.showlist, 'oxuser', 'oxfname', 'asc');document.forms.showlist.submit();" class="listheader"><?php echo smarty_function_oxmultilang(array('ident' => 'snpuserlistoxfname'), $this);?>
</a></td>
        <td class="listheader"><a href="javascript:top.oxid.admin.setSorting( document.forms.showlist, 'oxuser', 'oxlname', 'asc');document.forms.showlist.submit();" class="listheader"><?php echo smarty_function_oxmultilang(array('ident' => 'snpuserlistoxlname'), $this);?>
</a></td>
        <td class="listheader"><a href="javascript:top.oxid.admin.setSorting( document.forms.showlist, 'oxuser', 'oxusername', 'asc');document.forms.showlist.submit();" class="listheader"><?php echo smarty_function_oxmultilang(array('ident' => 'snpuserlistoxusername'), $this);?>
</a></td>
        <td class="listheader"><a href="javascript:top.oxid.admin.setSorting( document.forms.showlist, 'oxuser', 'oxregister', 'asc');document.forms.showlist.submit();" class="listheader"><?php echo smarty_function_oxmultilang(array('ident' => 'snpuserlistoxcreate'), $this);?>
</a></td>
...
"><a href="Javascript:editThis( '<?php echo $this->_tpl_vars['oUser']->oxuser__oxid->value; ?>
');" class="listitem<?php echo $this->_tpl_vars['blWhite']; ?>
"><?php echo $this->_tpl_vars['oUser']->oxuser__oxfname->value; ?>
</a></td>
            <td class="listitem<?php echo $this->_tpl_vars['blWhite']; ?>
"><a href="Javascript:editThis( '<?php echo $this->_tpl_vars['oUser']->oxuser__oxid->value; ?>
');" class="listitem<?php echo $this->_tpl_vars['blWhite']; ?>
"><?php echo $this->_tpl_vars['oUser']->oxuser__oxlname->value; ?>
</a></td>
            <td class="listitem<?php echo $this->_tpl_vars['blWhite']; ?>
"><a href="Javascript:editThis( '<?php echo $this->_tpl_vars['oUser']->oxuser__oxid->value; ?>
');" class="listitem<?php echo $this->_tpl_vars['blWhite']; ?>
"><?php echo $this->_tpl_vars['oUser']->oxuser__oxusername->value; ?>
</a></td>
            <td class="listitem<?php echo $this->_tpl_vars['blWhite']; ?>
"><a href="Javascript:editThis( '<?php echo $this->_tpl_vars['oUser']->oxuser__oxid->value; ?>
');" class="listitem<?php echo $this->_tpl_vars['blWhite']; ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['oUser']->oxuser__oxregister)) ? $this->_run_mod_handler('oxformdate', true, $_tmp) : smarty_modifier_oxformdate($_tmp)); ?>
</a></td>
...
";
    parent.parent.sMenuSubItem = "<?php echo smarty_function_oxmultilang(array('ident' => 'snpuserlistheader'), $this);?>
";
