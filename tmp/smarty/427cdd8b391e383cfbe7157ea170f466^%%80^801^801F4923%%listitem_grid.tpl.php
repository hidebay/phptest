...
smarty_core_load_plugins(array('plugins' => array(array('block', 'oxhasrights', 'widget/product/listitem_grid.tpl', 15, false),array('modifier', 'default', 'widget/product/listitem_grid.tpl', 34, false),array('modifier', 'oxaddparams', 'widget/product/listitem_grid.tpl', 292, false),array('function', 'oxmultilang', 'widget/product/listitem_grid.tpl', 166, false),)), $this); ?>
<div style='position: absolute; z-index:9999;color:white;background: #789;
                 padding:0 15 0 15'>widget/product/listitem_grid.tpl</div><!-- widget/product/listitem_grid.tpl template start -->
...
">
        ...
        <div class="priceBlock" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
            <?php $this->_tag_stack[] = array('oxhasrights', array('ident' => 'TOBASKET')); $_block_repeat=true;smarty_block_oxhasrights($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
                ...
                <span class="artno">
                	<?php echo smarty_function_oxmultilang(array('ident' => 'TRO_ARTNO'), $this);?>
...
<!-- widget/product/listitem_grid.tpl template end -->