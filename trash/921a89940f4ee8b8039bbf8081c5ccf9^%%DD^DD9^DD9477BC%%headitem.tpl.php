...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'headitem.tpl', 7, false),array('modifier', 'default', 'headitem.tpl', 102, false),array('function', 'math', 'headitem.tpl', 15, false),array('function', 'oxmultilang', 'headitem.tpl', 27, false),)), $this); ?>
...
<hr style="visibility:hidden;height:0;margin:0;padding:0;border:0;line-height:0;font-size:0;" class="debugBlocksStart" id="block_1532987173_<?php echo $this->_tpl_vars['_dbg_block_idr1']; ?>
<?php echo $this->_tpl_vars['_dbg_block_idr2']; ?>
" title="headitem.tpl-&gt;admin_headitem_inccss"><?php echo $this->_smarty_vars['capture']['_dbg_blocks']; ?>
<hr style="visibility:hidden;height:0;margin:0;padding:0;border:0;line-height:0;font-size:0;" class="debugBlocksEnd" title="block_1532987173_<?php echo $this->_tpl_vars['_dbg_block_idr1']; ?>
<?php echo $this->_tpl_vars['_dbg_block_idr2']; ?>
">
...
yui/oxid-help.js"></script>
  <?php $this->_smarty_vars['capture']['_dbg_blocks'] = ob_get_contents(); ob_end_clean(); ?><?php echo smarty_function_math(array('equation' => "rand()",'assign' => '_dbg_block_idr1'), $this);?>
<?php echo smarty_function_math(array('equation' => "rand()",'assign' => '_dbg_block_idr2'), $this);?>
<hr style="visibility:hidden;height:0;margin:0;padding:0;border:0;line-height:0;font-size:0;" class="debugBlocksStart" id="block_1602352035_<?php echo $this->_tpl_vars['_dbg_block_idr1']; ?>
<?php echo $this->_tpl_vars['_dbg_block_idr2']; ?>
" title="headitem.tpl-&gt;admin_headitem_incjs"><?php echo $this->_smarty_vars['capture']['_dbg_blocks']; ?>
<hr style="visibility:hidden;height:0;margin:0;padding:0;border:0;line-height:0;font-size:0;" class="debugBlocksEnd" title="block_1602352035_<?php echo $this->_tpl_vars['_dbg_block_idr1']; ?>
<?php echo $this->_tpl_vars['_dbg_block_idr2']; ?>
">
...
'+sParams, 'ajaxpopup', 'width=800,height=680,scrollbars=yes,resizable=yes');
  ...
  <?php $this->_smarty_vars['capture']['_dbg_blocks'] = ob_get_contents(); ob_end_clean(); ?><?php echo smarty_function_math(array('equation' => "rand()",'assign' => '_dbg_block_idr1'), $this);?>
<?php echo smarty_function_math(array('equation' => "rand()",'assign' => '_dbg_block_idr2'), $this);?>
<hr style="visibility:hidden;height:0;margin:0;padding:0;border:0;line-height:0;font-size:0;" class="debugBlocksStart" id="block_1146429887_<?php echo $this->_tpl_vars['_dbg_block_idr1']; ?>
<?php echo $this->_tpl_vars['_dbg_block_idr2']; ?>
" title="headitem.tpl-&gt;admin_headitem_js"><?php echo $this->_smarty_vars['capture']['_dbg_blocks']; ?>
<hr style="visibility:hidden;height:0;margin:0;padding:0;border:0;line-height:0;font-size:0;" class="debugBlocksEnd" title="block_1146429887_<?php echo $this->_tpl_vars['_dbg_block_idr1']; ?>
<?php echo $this->_tpl_vars['_dbg_block_idr2']; ?>
">
