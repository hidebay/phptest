<?php /* Smarty version 2.6.26, created on 2014-02-25 17:31:33
         compiled from layout/page.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'layout/page.tpl', 24, false),array('block', 'oxifcontent', 'layout/page.tpl', 43, false),array('function', 'oxmultilang', 'layout/page.tpl', 51, false),)), $this); ?>
<div style='position: absolute; z-index:9999;color:white;background: #789;
                 padding:0 15 0 15'>layout/page.tpl</div><!-- layout/page.tpl template start --><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
unset($_smarty_tpl_vars);
 ?>
            ...
            <?php endif; ?>            
            <div id="content">
              <?php if (( $this->_tpl_vars['oView']->getClassName() == 'start' || $this->_tpl_vars['oView']->getClassName() == 'alist' ) && count($this->_tpl_vars['oView']->getBanners()) > 0): ?>
                <div class="oxSlider">
                    <?php $_smarty_tpl_vars = $this->_tpl_vars;
