<?php /* Smarty version 2.6.26, created on 2014-02-25 17:27:17
         compiled from form/forgotpwd_email.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'oxmultilang', 'form/forgotpwd_email.tpl', 2, false),array('function', 'oxscript', 'form/forgotpwd_email.tpl', 4, false),array('function', 'oxcontent', 'form/forgotpwd_email.tpl', 27, false),)), $this); ?>
<div style='position: absolute; z-index:9999;color:white;background: #789;
                 padding:0 15 0 15'>form/forgotpwd_email.tpl</div><!-- form/forgotpwd_email.tpl template start --><?php echo smarty_function_oxmultilang(array('ident' => 'PAGE_ACCOUNT_FORGOTPWD_FORGOTPWD'), $this);?>
<br>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <li class="formSubmit">
        <button class="submitButton button" type="submit" title="<?php echo smarty_function_oxmultilang(array('ident' => 'PAGE_ACCOUNT_FORGOTPWD_REQUESTPWD'), $this);?>
...
<br><br>
<?php echo smarty_function_oxcontent(array('ident' => 'oxforgotpwd'), $this);?>
