<?php /* Smarty version 2.6.26, created on 2014-02-22 11:46:14
         compiled from widget/toparticlesslider.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'widget/toparticlesslider.tpl', 5, false),array('function', 'counter', 'widget/toparticlesslider.tpl', 8, false),array('function', 'oxmultilang', 'widget/toparticlesslider.tpl', 24, false),array('function', 'math', 'widget/toparticlesslider.tpl', 45, false),array('function', 'oxscript', 'widget/toparticlesslider.tpl', 71, false),array('block', 'oxhasrights', 'widget/toparticlesslider.tpl', 32, false),)), $this); ?>
...
<hr style="visibility:hidden;height:0;margin:0;padding:0;border:0;line-height:0;font-size:0;" class="debugBlocksStart" id="block_4042505947_<?php echo $this->_tpl_vars['_dbg_block_idr1']; ?>
<?php echo $this->_tpl_vars['_dbg_block_idr2']; ?>
" title="widget/toparticlesslider.tpl-&gt;widget_product_listitem_infogrid_price_value"><?php echo $this->_smarty_vars['capture']['_dbg_blocks']; ?>
<hr style="visibility:hidden;height:0;margin:0;padding:0;border:0;line-height:0;font-size:0;" class="debugBlocksEnd" title="block_4042505947_<?php echo $this->_tpl_vars['_dbg_block_idr1']; ?>
<?php echo $this->_tpl_vars['_dbg_block_idr2']; ?>
">
...
" class="pricePerUnit">
 ...
 <?php echo smarty_function_oxmultilang(array('ident' => 'WIDGET_PRODUCT_PRODUCT_ARTWEIGHT2'), $this);?>
                                    ...
                                    <?php $this->_smarty_vars['capture']['_dbg_blocks'] = ob_get_contents(); ob_end_clean(); ?><?php echo smarty_function_math(array('equation' => "rand()",'assign' => '_dbg_block_idr1'), $this);?>
<?php echo smarty_function_math(array('equation' => "rand()",'assign' => '_dbg_block_idr2'), $this);?>
<hr style="visibility:hidden;height:0;margin:0;padding:0;border:0;line-height:0;font-size:0;" class="debugBlocksStart" id="block_1029729623_<?php echo $this->_tpl_vars['_dbg_block_idr1']; ?>
<?php echo $this->_tpl_vars['_dbg_block_idr2']; ?>
" title="widget/toparticlesslider.tpl-&gt;widget_product_listitem_infogrid_price"><?php echo $this->_smarty_vars['capture']['_dbg_blocks']; ?>
<hr style="visibility:hidden;height:0;margin:0;padding:0;border:0;line-height:0;font-size:0;" class="debugBlocksEnd" title="block_1029729623_<?php echo $this->_tpl_vars['_dbg_block_idr1']; ?>
<?php echo $this->_tpl_vars['_dbg_block_idr2']; ?>
">
                                </div>
                       </div>
