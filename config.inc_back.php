 ...
 */
    ...
    /** @name database information */
        ...
        $this->dbName = 'usrdb_www02652'; // database name
        $this->dbUser = 'www02652'; // database user name
        $this->dbPwd = 'sxw752kw'; // database user password
        $this->dbType = 'mysql';
        $this->sShopURL = 'http://bodynova.de/phptest'; // eShop base url, required
        $this->sSSLShopURL  = null;            // eShop SSL url, optional
        $this->sAdminSSLURL = null;            // eShop Admin SSL url, optional
        $this->sShopDir = '/home/www0265/www.bodynova.de/phptest';
        $this->sCompileDir = '/home/www0265/www.bodynova.de/phptest/tmp';
