var oxid = {
    ...
    changeZoomlink: function(baseurl, zoomurl){
      var _el1 = document.getElementById('wrap_zoom_link_act');
      var _el2 = document.getElementById('wrap_zoom_link');
      if (_el1) 
        _el1.innerHTML = '<a id="test_zoom" rel="nofollow" href="" onclick="oxid.image(\'zoom_img\',\''+zoomurl+'\');oxid.popup.zoom();return false;"><img src="'+baseurl+'trans.gif" alt="" width="33" height="33"></a>';
      else if (_el2)
        _el2.innerHTML = '<a id="test_zoom" rel="nofollow" href="" onclick="oxid.image(\'zoom_img\',\''+zoomurl+'\');oxid.popup.zoom();return false;"><img src="'+baseurl+'trans.gif" alt="" width="33" height="33"></a>';
    },
    ...
    mdVariants: {
        ...
        showMdRealVariant: function() {
            ...
            if (selectedId && document.getElementById('mdvariant_' + selectedId)) {
                content = document.getElementById('mdvariant_' + selectedId).innerHTML; 
                content = content.replace(/product_img_/gi, 'product_img_act');
                content = content.replace(/wrap_zoom_link/gi, 'wrap_zoom_link_act');
                document.getElementById('md_variant_box').innerHTML = content; 
            }
