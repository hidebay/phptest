...
/**
 *    Prepared config.inc.php file for preconfigured installation on the OXVM.
 *    Learn more: http://wiki.oxidforge.org/Downloads/VMware
 */
 ...
 */
    ...
    /** @name database information */
        ...
        $this->dbType = 'mysql';
        $this->sShopURL = 'http://localhost/phptest'; // eShop base url, required
        $this->sSSLShopURL  = null;            // eShop SSL url, optional
        $this->sAdminSSLURL = null;            // eShop Admin SSL url, optional
        $this->sShopDir = '/var/www/phptest';
    ...
    $this->blForceSessionStart = 1; //false
